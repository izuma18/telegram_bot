...
async def make_changes_command(message: types.Message):
    ...
    await bot.send_message(message.from_user.id, 'Что надо хозяйка?', reply_markup=admin_kb.button_case_admin)
...
@dp.callback_query_handler(lambda x: x.data and x.data.stratswith('del '))
...
def register_handlers_admin(dp: Dispatcher):
    ...
    dp.callback_query_handler(del_callback_run, lambda x: x.data and x.data.stratswith('del '))
